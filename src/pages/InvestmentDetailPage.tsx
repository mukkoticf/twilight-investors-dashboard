...
const InvestmentDetailPage = () => {
  ...
  const paidPayments = quarterlyPayments.filter(payment => payment.payment_status === 'Paid').length;
    ...
    <PageLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Payments Status</CardTitle>
              <TrendingUp className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{paidPayments}/{quarterlyPayments.length}</div>
              <p className="text-xs text-muted-foreground">
                Paid quarters
              </p>
            </CardContent>
